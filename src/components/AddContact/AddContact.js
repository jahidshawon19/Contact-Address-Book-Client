    ...
    return (
        ...
        <Navbar></Navbar>
            <div className="container">
                <h4 className='text-center text-dark mt-5'>Add New Contact</h4>
                <div className="row py-3">
                    ...
                    <form onSubmit={handleAddContact}>
                        ...
                        <div className="form-group">
                            ...
                            <input type="tel"  className="form-control" ref={telePhoneRef} required/>
                        </div>
                        <div className="form-group">
                            <label>Mobile Phone Number</label>
                            <input type="tel"  className="form-control" ref={mobilePhoneRef} 
                              required />
                        </div>
                        ...
                        <div className="form-grou">
                            <label>Country</label>
                            <select className="form-control" ref={countryRef} required  >
